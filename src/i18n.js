...
const TRANSLATIONS = {
  es: {
    ...
    'btn.splitV':            'Dividir vertical (Ctrl+Shift+E)',
    ...
    'btn.duplicateTab':      'Duplicar pestaña (Ctrl+Shift+D)',
